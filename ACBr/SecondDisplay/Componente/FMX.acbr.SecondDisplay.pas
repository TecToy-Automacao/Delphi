...
Type
   ...
   TJPlayVideo = class(TJavaGenericImport<JPlayVideoClass, JPlayVideo>) end;
  ...
  private
    [Weak] FScene: TACBrCustomSecondDisplayLayout;
    FBuffer: TBitmap;
  ...
  public
    constructor Create(const AScene: TACBrCustomSecondDisplayLayout); reintroduce;
...
Procedure Register;
Begin
RegisterComponents('ACBr Mobile',
...
{$IFDEF ANDROID}
function TACBrCustomSecondDisplayLayout.BitmapToJBitmap(const ABitmap: TBitmap): JBitmap;
var
...
if (csDesigning In ComponentState) then
   ...
   Canvas.FillRect(TrectF.Create(0, 0, width, height), 0, 0, [], AbsoluteOpacity);
   End;
end;
...
procedure TACBrCustomSecondDisplayLayout.SetBackgroundColor(const Value: TAlphaColor);
begin
