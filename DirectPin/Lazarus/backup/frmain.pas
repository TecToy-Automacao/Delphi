...
var
  ...
  DirectPinMessage: TDPSerialMessage;
  b: Byte;
  s: AnsiString;
...
begin
  ...
  try
    ...
    DirectPinMessage := TDPSerialMessage.Create;
    try
      DirectPinMessage.PayLoad := Payload;
      s := DirectPinMessage.message;
      ...
      try
        try
          DirectPinMessage.message := s;
          JSonResp := DirectPinMessage.PayLoad;
        except
          On E: Exception do
          begin
            Log(E.Message);
